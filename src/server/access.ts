 ...
 * application lists. Any other name that reaches the same deployment — the
 * pages.dev address, a preview, a hostname typed wrong in the dashboard — goes
 * straight to the functions. So every API request proves it passed through
 * Access by carrying the token Access signed, and anything else is refused.
 */
